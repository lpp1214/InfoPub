...
public class AdminAction extends AdminSuperAction {
	...
	public String ListShow(){
		System.out.println("正在执行AdminAction中的ListShow()方法");
		request.setAttribute("mainPage","../info/listshow.jsp");
		session.remove("adminOP");	
		
		int infoType=showType.getInfoType();
		String stateType=showType.getTypeState();
		String payforType=showType.getTypePayfor();
		...
		List<InfoSingle> adminlistshow=myOp.OpListShow(sqlsub, params);
		System.out.println("查询结果总条数为：" + adminlistshow.size());
		System.out.println("当前页数：" + createPage.getCurrentP());
		System.out.println("总页数：" + createPage.getAllP());
	...
	public void validateListShow(){
		System.out.println("正在执行AdminAction中的validateListShow()方法");
		...
		if(adminOP.equals("Check")||adminOP.equals("Delete"))    //如果是进行了“通过审核”或“删除信息”操作后，再来调用ListShow()方法显示信息列表，则需要恢复之前选择的“显示方式”和“信息类别”状态，从而重新在ListShow()方法中查询出符合条件的记录
			...
			String getPayforType=showType.getTypePayfor();
			String getStateType=showType.getTypeState();
			System.out.println("InfoType:" + getInfoType);
			System.out.println("PayforType:" + getPayforType);
			System.out.println("StateType:" + getStateType);
	...
	public String CheckShow(){
		System.out.println("正在执行AdminAction中的CheckShow()方法");
	 ...
	 */
	public String Check(){
		System.out.println("正在执行AdminAction中的Check()方法");
		request.setAttribute("mainPage","../info/checkshow.jsp");
	...
	public String Delete(){
		System.out.println("正在执行AdminAction中的Delete()方法");
	...
	public String SetMoneyShow(){
		System.out.println("正在执行AdminAction中的SetMoneyShow()方法");
	...
	public void validateSetMoneyShow() {
		System.out.println("正在执行AdminAction中的validateSetMoneyShow()方法");
		request.setAttribute("mainPage","/pages/error.jsp");
