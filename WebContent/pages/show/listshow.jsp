            ...
            <s2:else>
                ...
                <s2:iterator status="onepayforStatus" value="onepayforlist">
                	<s2:if test="#status.even">
                           <tr><td align="center" style="border:1 solid" bgcolor="#F0F0F0"></td></tr>
                     </s2:if>
                     <s2:else>
                         <tr><td align="center" style="border:1 solid" bgcolor="#F0F0F0"></td></tr>
                      </s2:else>
                         <tr><td align="center" style="border:1 solid" bgcolor="white">
                             <table border="0" width="655" cellpadding="3" style="word-break:break-all">
                                 <tr height="30">
                                     <td colspan="1">【<s2:property value="#session.typeMap[infoType]"/>】</td>
                                     <td align="center"><s2:property value="infoTitle"/></td>
